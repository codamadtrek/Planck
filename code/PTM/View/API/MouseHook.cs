...
namespace Microsoft.Win32
{
	...
	public class MouseHook : LocalWindowsHook, IDisposable
	{
		...
		private MouseHookEventArgs _CrackHookMsg( IntPtr wParam, Win32.MOUSEHOOKSTRUCT hookStruct )
		{
		...
		private MouseButtons _GetXButton()
		{
		...
		private void _RaiseMouseHookEvent( IntPtr wParam, MouseHookEventArgs args )
		{
			switch( wParam.ToInt32() )
			{
				// mousemove messages
		...
		protected int MouseProc( int code, IntPtr wParam, IntPtr lParam )
		{
			...
			if( code == Win32.HC_ACTION )
				_RaiseMouseHookEvent( wParam,
									_CrackHookMsg( wParam,
		...
		private struct Win32
		{
			...
			#endregion Win32 Members

			#region Other

			public struct MOUSEHOOKSTRUCT
			{
				#region MOUSEHOOKSTRUCT Members
				...
				#endregion MOUSEHOOKSTRUCT Members
